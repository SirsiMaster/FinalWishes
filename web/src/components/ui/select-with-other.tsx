    ...
    <div className="space-y-2">
      <Select value={selected} onValueChange={handleSelect}>
        <SelectTrigger
          className={
            triggerClassName ??
            'w-full px-6 py-4 h-auto rounded-2xl border-slate-200 bg-[#F8FAFC] focus-visible:bg-white focus-visible:border-[#133378] font-semibold text-[#0F172A] text-base'
          }
        >
      ...
      {selected === OTHER && (
        <Input
          ...
          autoFocus
          className="px-6 py-4 h-auto rounded-2xl border-slate-200 bg-[#F8FAFC] focus-visible:bg-white focus-visible:border-[#133378] font-semibold text-[#0F172A] text-base"
        />
      )}
