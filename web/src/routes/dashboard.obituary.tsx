          ...
          >
            ...
            <div className="p-10 bg-gradient-to-t from-navy to-navy/40 border-t border-white/10">
              <div className="flex justify-between items-end text-left">
                <div>
                  <h3 className="text-3xl font-[family-name:var(--font-cinzel)] font-black text-white uppercase tracking-wider mb-2">Heritage Record Portrait</h3>
                  <p className="text-gold font-black text-xs uppercase tracking-[0.2em]">{userName || "Tameeka Lockhart"} · The Final Record</p>
                </div>
