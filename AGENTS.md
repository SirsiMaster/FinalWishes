...
| **AI** | **Codex Opus (sirsi-ai SDK)** | "The Shepherd" — AI guidance engine, completion scoring, obituary drafting (Genkit/Gemini fallback) |
...
*   **User**: "I want X."
*   **Codex Response**: "I see you want X. However, analyzing the ADRs, Y might be better because [Reason]. Should we do Y?"
