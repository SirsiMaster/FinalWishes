...
| :--- | :--- | :--- | :--- |
| **Brand Identity** (Logo, Typography, Palette) | Sr. Designer | 40 | $6,000 |
| **UX/UI Design System** (Figma: Web + Mobile) | Sr. Designer | 80 | $12,000 |
| **High-Fidelity Prototyping** | Product Design | 40 | $6,000 |
| **Asset Production** (Icons, Illustrations) | Visual Design | 40 | $6,000 |
| **Phase 0 Total** | | **200 hrs** | **$30,000** |
...
| **Frontend Guidance UI (Gantt/Tasks)** | Frontend Eng | 50 | $7,500 |
| **Phase 2 Total** | | **185 hrs** | **$30,000** |

### Phase 3: Living Legacy & Universal App (Weeks 11-16)
**Goal:** "Universal App" (React Native) for Pre-Death & Post-Death flows.

| Activity | Role | Est. Hours | Cost (Allocated) |
| :--- | :--- | :--- | :--- |
| **React Native Universal Shell** (iOS/Android) | Mobile Eng | 80 | $12,000 |
| **Living Legacy Features** (Memoirs, Multimedia) | Full Stack | 60 | $9,000 |
| **Heir Naming & Asset Distribution UI** | React Eng | 50 | $7,500 |
| **Document Scanner (OpenCV/Camera)** | Mobile Eng | 30 | $4,500 |
| **Phase 3 Total** | | **220 hrs** | **$33,000** |
...
| Activity | Role | Est. Hours | Cost (Allocated) |
| :--- | :--- | :--- | :--- |
| **Mini-Penetration Testing (External)** | Security Analyst| 40 | **$10,000** |
| **End-to-End Testing (Cypress)** | QA Eng | 60 | $9,000 |
| **SOC 2 Policy Generation** | Compliance | 20 | $3,000 |
| **App Store Submission & Polish** | Mobile Eng | 40 | $6,000 |
| **Phase 4 Total** | | **160 hrs** | **$28,000** |

**GRAND TOTAL: 925 Hours | $178,875 Value**  
**DISCOUNTED FIXED BID: $175,000**
...
**Total Estimated OpEx (Base): ~$60/month + Usage**
