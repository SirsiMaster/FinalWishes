  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8 pb-20 px-4 md:px-0">
      ...
      <div className="hidden print:block print-header">
        <h1>FINALWISHES</h1>
        <p style={{ fontSize: '14pt', color: '#334155', marginTop: '4px' }}>Final Record</p>
        <p style={{ fontSize: '11pt', color: '#64748B', marginTop: '4px' }}>{userName || 'Estate Record'}</p>
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-4 border-b border-slate-100 pb-6 md:pb-8">
        ...
        <div className="flex gap-3 w-full md:w-auto">
          ...
          <button className="no-print bg-[#C8A951] hover:bg-[#b8993f] text-white px-6 py-3 rounded-2xl font-bold text-[13px] transition-all shadow-lg flex items-center gap-2 active:scale-95">
          ...
          <button
            ...
            className="no-print bg-[#F1F5F9] hover:bg-[#E2E8F0] text-[#334155] px-6 py-3 rounded-2xl font-bold text-[13px] transition-all shadow-sm flex items-center gap-2 active:scale-95 border border-slate-200"
          >
