  ...
  return (
    <div className="max-w-[1240px] mx-auto space-y-10 pb-20 px-4">
      <div className="flex justify-between items-end border-b border-royal/10 pb-10">
        <div>
          <h2 className="text-4xl font-[family-name:var(--font-cinzel)] font-black text-royal uppercase tracking-tight mb-2">Active Estates</h2>
          <p className="text-[13px] text-royal/40 font-bold uppercase tracking-widest">Manage your primary and secondary estate plans across multiple locations.</p>
        </div>
        <button 
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
        {estates.map((e) => (
          <div key={e.id} className="bg-white p-12 rounded-[3.5rem] border border-royal/10 shadow-[0_2px_30px_rgba(19,51,120,0.03)] hover:shadow-[0_30px_70px_rgba(19,51,120,0.08)] hover:border-royal/20 transition-all group overflow-hidden relative group cursor-pointer border-t-4 border-t-royal/5 hover:border-t-royal/20">
            ...
            <div className="w-20 h-20 bg-royal/[0.03] rounded-[2rem] flex items-center justify-center mb-8 border border-royal/10 group-hover:bg-royal group-hover:text-white transition-all duration-500 shadow-sm">
            ...
            <div className="flex gap-4">
              ...
              <button className="flex-1 bg-royal text-white px-8 py-4 rounded-2xl text-[11px] font-black uppercase tracking-widest hover:bg-sapphire transition-all shadow-[0_8px_24px_rgba(19,51,120,0.2)] hover:shadow-[0_12px_32px_rgba(15,82,186,0.3)] hover:-translate-y-0.5 active:scale-[0.98] border border-white/10">
                Open Estate
              </button>
            </div>
          </div>
      ...
      {modalOpen && (
        <div className="fixed inset-0 z-[200] flex items-center justify-center bg-royal/[0.05] backdrop-blur-xl p-4 animate-in fade-in duration-300">
          <div className="bg-white rounded-[3.5rem] p-16 max-w-xl w-full border border-royal/10 shadow-[0_40px_100px_rgba(19,51,120,0.15)] animate-in zoom-in duration-500 relative overflow-hidden">
            ...
            <h3 className="text-3xl font-[family-name:var(--font-cinzel)] font-black text-royal mb-3 uppercase tracking-tight">Add New Estate</h3>
            ...
            <form onSubmit={(e) => {
              ...
              <div className="group/field">
                <label className="text-[9px] font-black text-royal/30 uppercase tracking-[0.2em] mb-3 block group-hover/field:text-royal/60 transition-colors">Estate Name</label>
                <input name="name" required className="w-full px-8 py-5 rounded-2xl border border-royal/10 bg-royal/[0.01] focus:bg-white focus:border-royal focus:ring-[12px] focus:ring-royal/[0.03] outline-none font-black text-royal transition-all placeholder:text-royal/10 text-lg uppercase tracking-tight" placeholder="e.g. THE SMITHS FAMILY TRUST" />
              </div>
              <div className="group/field">
                <label className="text-[9px] font-black text-royal/30 uppercase tracking-[0.2em] mb-3 block group-hover/field:text-royal/60 transition-colors">Estate Type</label>
              ...
              <div className="flex gap-6 pt-6">
                ...
                <button type="submit" disabled={registerMutation.isPending} className="flex-1 py-5 rounded-2xl bg-royal text-white font-black text-[11px] uppercase tracking-[0.2em] hover:bg-sapphire shadow-[0_12px_32px_rgba(19,51,120,0.2)] hover:shadow-[0_12px_32px_rgba(15,82,186,0.3)] hover:-translate-y-0.5 transition-all disabled:opacity-50 active:scale-[0.98] border border-white/10">
                  {registerMutation.isPending ? 'Saving...' : 'Create Estate'}
                </button>
              </div>
            </form>
          </div>
