    ...
    <AuthGuard>
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-100 flex items-center justify-center p-6 font-[family-name:var(--font-inter)]">
        ...
        <div className="fixed inset-0 pointer-events-none overflow-hidden">
          ...
          <div className="absolute bottom-[-200px] left-[-200px] w-[600px] h-[600px] rounded-full bg-[var(--gold)]/[0.03] blur-3xl" />
        </div>

        <div className="relative w-full max-w-2xl">
          {/* ─── Resume affordance (non-blocking) ─── */}
          {hasDraft && (
            <div className="mb-6 flex items-center justify-between gap-4 rounded-2xl border border-[var(--gold)]/30 bg-[var(--gold)]/[0.06] px-5 py-3.5 animate-in fade-in slide-in-from-top-2 duration-500">
              <div className="flex items-center gap-3 min-w-0">
                <svg viewBox="0 0 24 24" className="w-5 h-5 flex-shrink-0 text-[var(--gold)]" fill="none" stroke="currentColor" strokeWidth="2">
                  <path d="M3 3v5h5" />
          ...
          {step === 0 && (
            <div className="animate-in fade-in slide-in-from-bottom-4 duration-700">
              <div className="text-center mb-16">
                <div className="w-20 h-20 mx-auto mb-8 rounded-3xl bg-[var(--royal)] flex items-center justify-center shadow-[0_20px_60px_rgba(19,51,120,0.2)]">
              ...
              <Button
                ...
                className="w-full py-6 h-auto bg-[var(--royal)] hover:bg-[var(--royal-blue)] text-white rounded-2xl font-bold text-lg transition-all shadow-[0_20px_60px_rgba(19,51,120,0.15)] hover:shadow-[0_25px_70px_rgba(19,51,120,0.25)] hover:-translate-y-0.5 active:scale-[0.99]"
              >
                ...
                <Card className="rounded-[2.5rem] p-12 border-slate-100 shadow-[0_20px_80px_rgba(15,23,42,0.04)] bg-white">
                  <CardHeader className="p-0 mb-10">
                    <div className="flex items-center gap-3 mb-4">
                      ...
                      <Badge variant="secondary" className="text-[11px] font-bold text-[var(--royal)]/30 uppercase tracking-[0.3em] bg-transparent px-0 h-auto border-0">
                        Step 1 of 5
                      </Badge>
                    </div>
                      ...
                      <div className="flex items-start gap-5">
                        ...
                        {wizardData.situation === 'planning' && (
                          <div className="ml-auto flex-shrink-0">
                            <div className="w-6 h-6 rounded-full bg-[var(--royal)] flex items-center justify-center">
                  ...
                  <CardFooter className="p-0 pt-8 border-0 bg-transparent">
                    <Button
                      ...
                      className="w-full py-5 h-auto rounded-2xl bg-[var(--royal)] hover:bg-[var(--royal-blue)] text-white font-bold text-lg transition-all shadow-xl hover:-translate-y-0.5 active:scale-[0.99] disabled:opacity-40 disabled:cursor-not-allowed flex items-center justify-center gap-3"
                    >
                      Continue
                ...
                <Card className="rounded-[2.5rem] p-12 border-slate-100 shadow-[0_20px_80px_rgba(15,23,42,0.04)] bg-white">
                  ...
                  <CardFooter className="p-0 pt-8 flex gap-4 border-0 bg-transparent">
                    ...
                    <Button
                      ...
                      className="flex-[2] py-5 h-auto rounded-2xl bg-[var(--royal)] hover:bg-[var(--royal-blue)] text-white font-bold text-lg transition-all shadow-xl hover:-translate-y-0.5 active:scale-[0.99] disabled:opacity-40 disabled:cursor-not-allowed flex items-center justify-center gap-3"
                    >
                      Continue
                      <svg viewBox="0 0 24 24" className="w-5 h-5" fill="none" stroke="currentColor" strokeWidth="2.5">
                        <path d="M5 12h14m-7-7 7 7-7 7" />
              ...
              {step === 3 && (
                <Card className="rounded-[2.5rem] p-12 border-slate-100 shadow-[0_20px_80px_rgba(15,23,42,0.04)] bg-white">
                  ...
                  <CardFooter className="p-0 pt-8 flex gap-4 border-0 bg-transparent">
                    ...
                    <Button
                      onClick={() => setStep(4)}
                      className="flex-[2] py-5 h-auto rounded-2xl bg-[var(--royal)] hover:bg-[var(--royal-blue)] text-white font-bold text-lg transition-all shadow-xl hover:-translate-y-0.5 active:scale-[0.99] flex items-center justify-center gap-3"
                    >
                      Continue
                      <svg viewBox="0 0 24 24" className="w-5 h-5" fill="none" stroke="currentColor" strokeWidth="2.5">
                        <path d="M5 12h14m-7-7 7 7-7 7" />
