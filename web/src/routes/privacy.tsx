...
function PrivacyPage() {
  return (
    <div className="min-h-screen bg-white px-6 py-20 max-w-3xl mx-auto font-[family-name:var(--font-inter)]">
      <h1 className="text-3xl font-bold text-royal mb-4 font-[family-name:var(--font-cinzel)]">Privacy Policy</h1>
      ...
      <Section title="1. Information We Collect">
        <p className="text-ink leading-relaxed mb-3">We collect information in the following categories:</p>
      ...
      <Section title="4. Third-Party Services">
        <p className="text-ink leading-relaxed mb-3">We use the following third-party services to operate the platform:</p>
        <div className="overflow-x-auto">
          <table className="w-full text-sm text-ink border border-[var(--neutral-border)] rounded-lg">
            <thead>
              <tr className="bg-[var(--neutral-faint)]">
                <th className="text-left px-4 py-2 font-semibold border-b border-[var(--neutral-border)]">Service</th>
                <th className="text-left px-4 py-2 font-semibold border-b border-[var(--neutral-border)]">Provider</th>
                <th className="text-left px-4 py-2 font-semibold border-b border-[var(--neutral-border)]">Purpose</th>
              </tr>
            </thead>
            <tbody>
      ...
      <Section title="7. Your Rights">
        ...
        <h3 className="text-lg font-semibold text-royal mt-6 mb-3">California Residents (CCPA/CPRA)</h3>
        <p className="text-ink leading-relaxed mb-3">
        ...
        <h3 className="text-lg font-semibold text-royal mt-6 mb-3">Maryland, Illinois &amp; Minnesota Residents</h3>
