    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-[var(--gold-dim)] via-[var(--gold-dim)] to-white">
        <div className="flex flex-col items-center gap-4">
          ...
          <p className="text-sm text-ink-muted/60 font-medium">Loading memorial...</p>
        </div>
      </div>
    )
  }
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-[var(--gold-dim)] via-[var(--gold-dim)] to-white">
        <div className="text-center max-w-md px-6">
          ...
          <h1 className="text-2xl font-[family-name:var(--font-cinzel)] font-bold text-royal mb-3">
            Memorial Not Found
          </h1>
          <p className="text-ink-muted/60 leading-relaxed">
    ...
    <div className="min-h-screen bg-gradient-to-b from-[var(--gold-dim)] via-[var(--gold-dim)] to-white">
      <div className="max-w-2xl mx-auto px-5 py-12 md:py-20">
        ...
        <section className="text-center mb-16">
          ...
          <h1 className="text-3xl md:text-4xl font-[family-name:var(--font-cinzel)] font-bold text-royal tracking-tight mb-3">
            {memorial.personName}
          </h1>

          {dateSpan && (
            <p className="text-lg text-ink-muted/70 font-light tracking-wide">
              {dateSpan}
            </p>
          )}
          ...
          <section className="mb-16">
            <Card className="rounded-3xl border-0 shadow-[0_4px_24px_rgba(200,169,81,0.08)] bg-white/80 backdrop-blur-sm">
              <CardContent className="p-8 md:p-12">
                <div
                  className="text-ink text-[16px] leading-[1.85] font-light prose prose-sm max-w-none"
        ...
        {memorial.serviceDetails && (memorial.serviceDetails.date || memorial.serviceDetails.location) && (
          <section className="mb-16">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="text-sm font-bold text-ink-muted/50 uppercase tracking-[0.15em]">
                Service Information
              </h2>
            </div>
                  ...
                  <div className="flex items-center gap-3 text-ink">
                    ...
                    <div>
                      ...
                      {memorial.serviceDetails.address && (
                        <p className="text-sm text-ink-muted/60 mt-0.5">{memorial.serviceDetails.address}</p>
                      )}
                    </div>
                  </div>
                )}
        ...
        <section className="text-center pt-8 pb-16">
          ...
          <p className="text-xs text-ink-muted/40 mb-4">
